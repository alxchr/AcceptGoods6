...
public class App extends Application {
    ...
    public static final String appName = "AcceptGoods6";
    static String TAG = "App";
    static SharedPreferences sp;
    private static int storeIndex, storeMan;
    private static String storeId, storeName, dctNum;
...
//        Log.d(TAG,"Start application store id =" + storeId + " store index = " + storeIndex + " current box name " + currentBoxName + " id " + currentBoxId);
